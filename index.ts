...
const yupPort = extractTypeSignature("./src/yup/index.ts", "Airport");
const structPort = extractTypeSignature("./src/superstruct/index.ts", "Airport");
// write to file or console log
console.log("YUP");
console.log(yupPort);
console.log("----------");
console.log("STRUCT");
console.log(structPort);